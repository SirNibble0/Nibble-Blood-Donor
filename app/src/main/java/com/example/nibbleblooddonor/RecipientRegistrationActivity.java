        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bloodGroup.equals("Select your blood group")){
                    ...
                    Toast.makeText(RecipientRegistrationActivity.this, "Blood group is required!!", Toast.LENGTH_SHORT).show();
                    return;
                    ...
                    mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()){
                                ...
                                userinfo.put("search", "recipient" + bloodGroup);//This helps us to filter the blood groups in the spinner
                                ...
                                if (resultUri != null){
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        userDatabaseRef.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                            ...
                                                            public void onComplete(Task task) {
                                                                ...
                                                                if (task.isSuccessful()){
                                                                    Toast.makeText(RecipientRegistrationActivity.this, "imageUrl added to database successfully", Toast.LENGTH_SHORT).show();
                                                                }else {
                                                                    Toast.makeText(RecipientRegistrationActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                                                }
                                    ...
                                    startActivity(new Intent(RecipientRegistrationActivity.this, MainActivity.class));
                                    loader.dismiss();
